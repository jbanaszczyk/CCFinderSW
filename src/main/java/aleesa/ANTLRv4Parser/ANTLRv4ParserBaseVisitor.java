...
public class ANTLRv4ParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ANTLRv4ParserVisitor<T> {
     ...
     */
    @Override
    public T visitChannelsSpec(ANTLRv4Parser.ChannelsSpecContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitIdList(ANTLRv4Parser.IdListContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitActionBlock(ANTLRv4Parser.ActionBlockContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitArgActionBlock(ANTLRv4Parser.ArgActionBlockContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitLexerRuleSpec(ANTLRv4Parser.LexerRuleSpecContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitCharacterRange(ANTLRv4Parser.CharacterRangeContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitIdentifier(ANTLRv4Parser.IdentifierContext ctx) {
        return visitChildren(ctx);
    }
}